...
public class Transaction implements Serializable {
   ...
   public class Output implements Serializable {
      ...
      public PublicKey address;      // the address or public key of the recipient
      ...
      public boolean equals(Object other) {
         ...
         if (value != op.value)
            return false;
         if (!((RSAPublicKey) address).getPublicExponent().equals(((RSAPublicKey)op.address).getPublicExponent()))
            return false;
         if (!((RSAPublicKey) address).getModulus().equals(((RSAPublicKey) op.address).getModulus()))
            return false;
         return true;
      }
